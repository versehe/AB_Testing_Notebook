...
Once we decide the confidence level, we could either get the confidence inteval or, reverse the process, calculate the z score and compare with the confidence level.        
