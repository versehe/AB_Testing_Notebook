...
```Power = 1 - Beta```, it indicates the probablity of rejecting null when alternative is true, it's a good thing. when beta is small enough, power should reach close to 1.                     
